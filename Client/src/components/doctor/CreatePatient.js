...
const CreatePatient = props => {
  ...
  const onFinish = valuesToPass => {
    ...
    // This line sets the medicines field of the valuesToPass object to the current value of the medicines state variable.
    valuesToPass.medicines = medicines;
  ...
  // The `handleMedChange`, `handleMedAdd`, and `handleMedRemove` functions work in the same way as their counterparts for `fields`, but they operate on the `medicines` state value instead.
